                ...
                <div className="admin-page">
                    <div className="admin-page__content">
                        <div style={{ textAlign: 'center', padding: '4rem 2rem' }}>
                            ...
                            <p style={{ color: 'var(--color-text-light)', margin: 0 }}>Loading dashboard...</p>
                        </div>
                    </div>
                </div>
            </AdminLayout>
                ...
                <div className="admin-page__header">
                    <div className="admin-page__header-content">
                        <div className="admin-page__header-left">
                            <h1>Dashboard</h1>
                            <p>Welcome to your VENFURNER admin panel. Here's an overview of your store performance.</p>
                        </div>
                        <div className="admin-page__header-right">
                            <div className="admin-page__stats">
                                <div className="admin-page__stat">
                                    ...
                                    <span className="admin-page__stat-value">{stats.totalProducts}</span>
                                </div>
                                <div className="admin-page__stat">
                ...
                <div className="admin-page__content">
                    ...
                    <div className="dashboard-metrics">
                        ...
                        <div className="dashboard-metrics-grid">
                            <div className="dashboard-metric">
                                <div className="dashboard-metric__label">Average Order Value</div>
                                <div className="dashboard-metric__value">₹{(stats.avgOrderValue || 0).toLocaleString()}</div>
                                <div className="dashboard-metric__change dashboard-metric__change--positive">+12.5%</div>
                            </div>
                            <div className="dashboard-metric">
                                <div className="dashboard-metric__label">Conversion Rate</div>
                                <div className="dashboard-metric__value">{(stats.conversionRate || 0).toFixed(1)}%</div>
                                <div className="dashboard-metric__change dashboard-metric__change--positive">+3.2%</div>
                            </div>
                            <div className="dashboard-metric">
                                <div className="dashboard-metric__label">Categories</div>
                                <div className="dashboard-metric__value">{stats.totalCategories}</div>
                                <div className="dashboard-metric__change dashboard-metric__change--positive">+5.1%</div>
                            </div>
                            <div className="dashboard-metric">
                                <div className="dashboard-metric__label">Pending Orders</div>
                                <div className="dashboard-metric__value">{stats.pendingOrders}</div>
                                <div className="dashboard-metric__change dashboard-metric__change--negative">-2.3%</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="dashboard-actions">
                        <div className="dashboard-action-card">
                            <h3>Quick Actions</h3>
                            <p>Manage your store efficiently with these quick access features.</p>
                        ...
                        <div className="dashboard-action-card">
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div>
                                        <p style={{ margin: '0 0 0.25rem 0', fontWeight: '500', color: 'var(--color-text)' }}>
                                            New order received
                                        </p>
