...
const ProductList = ({ products, loading, onEdit, onDelete, onUpdateStock }: ProductListProps) => {
                            ...
                            <tr key={product.id || `product-${index}`}>
                                ...
                                <td>
                                    <div className="admin-product-stock">
                                        <span className={`admin-product-stock__badge ${product.quantityAvailable > 0 ? 'in-stock' : 'out-of-stock'}`}>
                                ...
                                <td>
                                    <div className="admin-product-stock-actions">
                                        <button
                                            ...
                                            onClick={() => onUpdateStock(product.id, Math.max(0, product.quantityAvailable - 1))}
                                        ...
                                        <span className="admin-stock-quantity">{product.quantityAvailable}</span>
                                        <button
                                            type="button"
                                            className="admin-stock-btn admin-stock-btn--increase"
                                            onClick={() => onUpdateStock(product.id, product.quantityAvailable + 1)}
