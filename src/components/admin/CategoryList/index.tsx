        ...
        <div className="admin-category-list">
                            ...
                            <tr key={category.id || `category-${index}`}>
                                ...
                                <td>
                                    <div className="admin-category-status">
                                        <span className={`admin-category-status__badge ${category.isActive ? 'active' : 'inactive'}`}>
                                            {category.isActive ? 'Active' : 'Inactive'}
                                        </span>
                                    </div>
                                </td>
                                <td>
                                    <span className="admin-category-order">{category.sortOrder || 0}</span>
                                </td>
                                <td>
            ...
            {sortedCategories.length === 0 && (
                <div className="admin-empty-state">
                    <p>No categories found. {searchTerm && 'Try adjusting your search.'}</p>
                </div>
            )}
        </div>
    );
