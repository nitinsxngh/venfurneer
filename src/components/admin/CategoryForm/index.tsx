    ...
    return (
        <div className="category-form">
            <div className="category-form__header">
                ...
                <p>{category ? 'Update the category information below' : 'Create a new category for your products'}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="category-form__form">
                ...
                <div className="category-form__section">
                    ...
                    <div className="category-form__field">
                        ...
                        <small className="category-form__help">This will be used in the URL: yourstore.com/categories/[slug]</small>
                    </div>
                    ...
                    <div className="category-form__field">
                        ...
                        />
                        <small className="category-form__help">Optional: Add an image to represent this category</small>
                    </div>
                </div>
                    ...
                    <div className="category-form__field">
                        <label className="category-form__checkbox">
                            <input
                                ...
                                onChange={handleInputChange}
                            />
                            <span className="category-form__checkbox-text">Active Category</span>
                        </label>
                        <small className="category-form__help">Inactive categories won't be visible to customers</small>
                    </div>
                </div>
