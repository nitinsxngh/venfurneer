...
const ProductForm = ({ product, onSubmit, onCancel }: ProductFormProps) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (validateForm()) {
            ...
            if (productData.discount > 0) {
                productData.currentPrice = Math.round(productData.price * (1 - productData.discount / 100));
            } else {
    ...
    const updateArrayItem = (field: 'images' | 'sizes' | 'colors', index: number, value: string) => {
        setFormData(prev => ({
            ...prev,
        ...
        <div className="admin-product-form">
            ...
            <form onSubmit={handleSubmit} className="admin-form">
                    ...
                    <div className="admin-form__row">
                        ...
                        <div className="admin-form__field">
                            ...
                            <input
                                ...
                                max="100"
                            />
                            {errors.discount && <span className="admin-error">{errors.discount}</span>}
                        </div>
                        ...
                        <div className="admin-form__field">
                            ...
                            <div className="admin-form__quantity-controls">
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleInputChange('quantityAvailable', Number(e.target.value))}
                            ...
                            {errors.quantityAvailable && <span className="admin-error">{errors.quantityAvailable}</span>}
                        </div>
                    </div>
                </div>
                ...
                <div className="admin-form__actions">
                    ...
                    <button type="button" onClick={onCancel} className="btn btn--rounded btn--border">
                        Cancel
                    </button>
                </div>
            </form>
